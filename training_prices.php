...
<head>  
   ...
   ================================================== -->
   <meta charset="utf-8">
	<title>Ki's K-9 Dog Training | Prices in the 757</title>
	<meta name="description" content="Virginia Beach Dog Training. Ki's K-9 - Training and prices; balanced training ">
...
<?php include 'header.php';?>
   ...
   <div class="row" >   		
		<div class="ten columns align-left" style="text-align: left; vertical-align:bottom; color:black; ">
			<br>
			<h2>Training Prices</h2>	   			
			</div>	
		
		<div class="two columns align-left"  style="text-align: right">	 
			<img alt="Ki's K-9 logo" src="FullSizeR1 (1) 100.jpg" height="60" > 		
		</div>
	</div>
...
Unfortunately, untrained dogs are the norm, and trained dogs really stood out. I wanted to make one-on-one dog training more affordable for people. I also offer Pick-up and Train for the super-busy. Sadly, sometimes dogs are removed from the home because of bad behavior. This can be avoided through training. I don't want the cost of training to stop dogs from getting the training they should have. Good training benefits the whole family, the dog, and the people and animals around us. I invite you to take a look at my testimonials page to read what my customers have to say about my training. My success encourages me to work harder to improve dog behavior.
			...
			<h3>Virginia Beach dog training prices:</h3> 
			<ul>
 				<li>Initial consult is free</li>
				<li>Basic obidence: $50 hourly</li>
				<li>Puppy obidence: $50 hourly </li>
				<li>Advanced obedience: $65 hourly</li>
				<li>eCollar training: $70 hourly</li>
				<li>Behavior modification: $75 hourly</li>
